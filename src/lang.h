...
enum {
    ...
    STR_NET_TAB_ADAPTER, STR_NET_TAB_WIFI,
    STR_NET_RX_PIN, STR_NET_TX_PIN,
    STR_NET_PROBING, STR_NET_NO_ADAPTER_PINS, STR_NET_ADAPTER_HINT,
    STR_NET_INVALID_PINS,
    ...
    /* Clock / RTC settings */
    STR_CLOCK, STR_RTC_SCL_PIN, STR_RTC_SDA_PIN, STR_RTC_TEST,
    STR_RTC_DETECTED, STR_RTC_NOT_FOUND, STR_RTC_DETECTING,
    STR_RTC_SET_TIME, STR_RTC_DATE, STR_RTC_TIME, STR_RTC_APPLY,
    STR_RTC_HINT, STR_RTC_TIME_SET, STR_RTC_BAD_PINS, STR_RTC_BAD_TIME,
